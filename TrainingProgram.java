...
public class TrainingProgram {
	...
	private int userCount; //κωδικος χρηστη
	...
	TrainingProgram(int userCount, Sport sport, Facility facility, Coach coach, int minExperience, boolean weeklyResernvation, char gender, float minDuration, int day){
