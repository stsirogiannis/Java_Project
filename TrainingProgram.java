...
public class TrainingProgram {
	...
	private User password; //κωδικος χρηστη
	...
	TrainingProgram(User password, Sport sport, Facility facility, Coach coach, int minExperience, boolean weeklyResernvation, User gender, float minDuration, int day){
	...
	public void setPassword(User password) {                 //ορισμος μεθοδων getters και setters για τη θεση και την ανακτηση των τιμων της 
