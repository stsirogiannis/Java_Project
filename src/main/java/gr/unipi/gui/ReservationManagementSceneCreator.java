...
public class ReservationManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    public ReservationManagementSceneCreator(double width, double height) {
        ...
        // Customize reservationTableView: Create Column, create Cell and set it to Column. Add Column to TableView
        reservationTableView.setPrefSize(660, 550);
        ...
        TPCountColumn.setPrefWidth(230);
        ...
        dateStringColumn.setPrefWidth(150);
    ...
    public void handle(MouseEvent event) {
        ...
        // Get values from fields, create new Reservation (based on these values) add it to reservationList
        if (event.getSource() == newReservationBtn) {
            ...
            if (isValid==true) { //if the number is valid
        ...
        if (event.getSource() == reservationTableView) {
            ...
            if (selectedReservation != null) {
                userCountField.setText(String.valueOf(selectedReservation.getAthlete().getUserCount()));
    ...
    // create a new TrainingProgramReservation object and add it to reservationList
    ...
    //method that finds the user from the reservationList and deletes their reservation
    ...
    //clear the text input from user
