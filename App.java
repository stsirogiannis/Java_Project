...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        SceneCreator subscriptionSceneCreator = new SubscriptionManagementSceneCreator(1060, 695);
        subscriptionScene = subscriptionSceneCreator.createScene();

        SceneCreator reservationSceneCreator = new ReservationManagementSceneCreator(1050,500);
