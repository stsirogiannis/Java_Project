...
public class ReservationManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    public TrainingProgramReservation trainingProgramReservation;
    ...
    public void handle(MouseEvent event) {
        ...
        // Delete reservation by reservation code
        if (event.getSource() == cancelReservationBtn) {
        	  if (trainingProgramReservation != null) {
                  deleteTrainingProgramReservation(trainingProgramReservation.getTPRCode());
                  tableSync();
                  clearTextFields();
              } else {
                  Alert alertType = new Alert(Alert.AlertType.ERROR);
                  alertType.setTitle("Μη έγκυρη επιλογή");
                  alertType.setContentText("Παρακαλώ επιλέξτε μία κράτηση για διαγραφή.");
                  alertType.show();
              }
        }
        ...
        if (event.getSource() == reservationTableView) {
            ...
            if (selectedReservation != null) {
                ...
                dateString = String.valueOf(selectedReservation.getDateString());
            }
