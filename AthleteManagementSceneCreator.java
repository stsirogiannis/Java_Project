...
public class AthleteManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    //	Second scene labels
    Label userCountLbl, nameLbl, surnameLbl, ageLbl, genderLbl, contactInfoLbl, birthDateLbl, professionalLbl, experienceLbl;
    //	Second scene TextFields
    TextField userCountField, nameField, surnameField, genderField, contactInfoField, birthDateField, professionalField, experienceField;
    //	TableView
    ...
    public AthleteManagementSceneCreator(double width, double height) {
        ...
        inputFieldsPane.add(genderLbl, 0, 2);
        inputFieldsPane.add(genderField, 1, 2);
        inputFieldsPane.add(contactInfoLbl, 0, 3);
        inputFieldsPane.add(contactInfoField, 1, 3);
        inputFieldsPane.add(birthDateLbl, 0, 4);
        inputFieldsPane.add(birthDateField, 1, 4);
        ...
        TableColumn<Athlete, String> ageColumn = new TableColumn<>("Surname");
        ageColumn.setCellValueFactory(new PropertyValueFactory<>("surname"));
...
//      	  createDog(name, age, breed, gender);
            ...
            try {
                char gender = Integer.parseInt(genderField.getText());
                createDog(name, age, breed, gender);
    ...
    public void createAthlete(int userCount, String name, String surname, char gender, String birthDate, String contactInfo) {
        User ath = new Athlete(userCount, name, surname, gender, birthDate, contactInfo);
        athleteList.add(ath);
    }
