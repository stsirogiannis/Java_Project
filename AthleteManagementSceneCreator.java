...
public class AthleteManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    public AthleteManagementSceneCreator(double width, double height) {
        ...
        /*TableColumn<Enrollment, Integer> userCountColumn1 = new TableColumn<>("Κωδικός Αθλητή");
        userCountColumn1.setCellValueFactory(new PropertyValueFactory<>("userCount"));
        athleteTableView.getColumns().add(userCountColumn1);
        userCountColumn1.setPrefWidth(200);*/
    ...
    public void tableSyncPayment() {
        List<Enrollment> items = enrollmentTableView.getItems();
        items.clear();
        items.addAll(enrollmentList);
    }
