...
public class AthleteManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    Button newDogBtn, updateDogBtn, deleteDogBtn, backBtn;
    //	Second scene labels
    Label nameLbl, surnameLbl, ageLbl, breedLbl, genderLbl;
    //	Second scene TextFields
    TextField nameField, ageField, breedField, genderField;
    //	TableView
    ...
    public AthleteManagementSceneCreator(double width, double height) {
        ...
        //Buttons
        newDogBtn = new Button("New Dog");
        updateDogBtn = new Button("Update");
        deleteDogBtn = new Button("Delete");
        ...
        newDogBtn.setOnMouseClicked(this);
        updateDogBtn.setOnMouseClicked(this);
        deleteDogBtn.setOnMouseClicked(this);
        athleteTableView.setOnMouseClicked(this);

        //  Customize buttonFlowPane (add buttons to FlowPane)
        buttonFlowPane.setHgap(10);
        buttonFlowPane.getChildren().add(newDogBtn);
        buttonFlowPane.getChildren().add(updateDogBtn);
        buttonFlowPane.getChildren().add(deleteDogBtn);
