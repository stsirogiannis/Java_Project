...
public class AthleteManagementSceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
    ...
    TableView<PaymentInfo> paymentTableView;
    ...
    public AthleteManagementSceneCreator(double width, double height) {
        ...
        paymentTableView.setOnMouseClicked(this);
        ...
        rootGridPane.add(paymentTableView, 0, 1);
        ...
        paymentTableView.setPrefSize(770, 250);
        ...
        TableColumn<PaymentInfo, String> enrollmentDateColumn = new TableColumn<>("Hμ. Εγγραφής");
        enrollmentDateColumn.setCellValueFactory(new PropertyValueFactory<>("enrollmentDate"));
        paymentTableView.getColumns().add(enrollmentDateColumn);
        enrollmentDateColumn.setPrefWidth(200);

        TableColumn<PaymentInfo, Double> enrollmentAmountColumn = new TableColumn<>("Ποσό Εγγραφής");
        enrollmentAmountColumn.setCellValueFactory(new PropertyValueFactory<>("enrollmentAmount"));
        paymentTableView.getColumns().add(enrollmentAmountColumn);
        enrollmentAmountColumn.setPrefWidth(200);
    ...
    private void showEnrollmentPayWindow(Athlete selectedAthlete) {
        ...
        layout.getChildren().addAll(dateLabel, datePicker, methodLabel, paymentMethodChoice, payButton);
        ...
        payButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                Enrollment enrollment = new Enrollment(selectedAthlete.getUserCount(), selectedAthlete, date.toString(), 0, 0);
                double totalCost = enrollment.calculateTotalPrice();

                // Create Payment object
                Payment payment = new Payment(++payCode, date.toString(), method, null, enrollment, totalCost);
